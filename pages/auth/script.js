    // ====== AUTH PAGE SCRIPT - UPDATED WITH @example.com FIX ======
        // Modal functions
        function showTerms() {
        ...
        // Handle form submission - FIXED WITH @example.com
        async function handleSignup(event) {
            ...
            try {
                // 1. CREATE EMAIL WITH @example.com (auto-confirmed)
        ...
        async function initAuthPage() {
            console.log("✨ Luster Signup Page Initialized");
